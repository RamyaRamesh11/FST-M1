...
C.City 'City' , 
S.Salesman_Name 'SalesmanName', 
S.Commission from customers C 
INNER JOIN 
salesman S ON C.Salesman_ID=S.Salesman_ID;
...
ELECT a.customer_name AS "Customer Name", a.city, b.name AS "Salesman", b.commission FROM customers a  
...
ELECT a.customer_name, a.city, a.grade, b.salesman_name AS "Salesman", b.Salesman_city FROM customers a  
...
NNER JOIN customers b ON a.customer_id=b.customer_id  
