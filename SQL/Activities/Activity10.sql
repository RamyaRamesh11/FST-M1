...
REM   To perform subquery operation
...
SELECT a.customer_name AS "Customer Name", a.city, a.name AS "Salesman", a.commission FROM customers a  
INNER JOIN salesman b ON a.salesman_id=b.salesman_id;

SELECT a.customer_name AS "Customer Name", a.city, a.name AS "Salesman", b.commission FROM customers a  
INNER JOIN salesman b ON a.salesman_id=b.salesman_id;
