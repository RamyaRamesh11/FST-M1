...
public class Activity11_4 {
    public static void main(String[] args) throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='sub header']")));
        //Get heading on new page
        newTabText = driver.findElement(By.xpath("//div[@class='sub header']")).getText();
        System.out.println("New tab heading is: " + newTabText);
